            ...
            {!isLoading &&
              items.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800">
                  <td className="truncate px-4 py-2 font-mono text-xs text-gray-700 dark:text-gray-300">
  ...
  if (!precedent) {
    return (
      <div className="space-y-3">
        <p className="text-sm text-gray-600 dark:text-gray-400">Precedent not found.</p>
